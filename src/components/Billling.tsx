...
const Billing = () => (
    ...
    <section id='product' className={`${layout.sectionReverse} xl:px-0 sm:px-16 md:px-14 px-6`}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nihil quaerat quis hic deleniti doloremque consequatur. Molestiae nemo voluptates ipsam in.
        </p>
